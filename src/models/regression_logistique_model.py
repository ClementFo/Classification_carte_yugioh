...
filtres = {
    "Sans": "data/Yugi_images",
    "Canny": "data/Yugi_images_processed/Canny",
    "Erosion": "data/Yugi_images_processed/Erosion",
    "Gaussian Blur": "data/Yugi_images_processed/Gaussian Blur",
    "HoughLinesP": "data/Yugi_images_processed/HoughLinesP",
    "Laplacian": "data/Yugi_images_processed/Laplacian",
    "Sobel": "data/Yugi_images_processed/Sobel",
}
...
for nom_filtre, path in filtres.items():
    print(f"Nom filtre : {nom_filtre}")
    X_tmp, y_tmp = bf.load_images_from_df(df, path)
    target_height = 256
    target_width = 177
    X_tmp_resized = [
    ...
    for parametre in parameter:
        ...
        modele_name_file = "models/" + model_type + "_" + penalty + "_" + solver + "_"
        modele_name_file = modele_name_file + "_" + nom_filtre
...
output_file = os.path.join(data_dir, "results_regression_logistique_1.csv")

if os.path.exists("reports/csv_export/results_regression_logistique_1.csv"):
    df_results.to_csv("reports/csv_export/results_regression_logistique_1.csv",
